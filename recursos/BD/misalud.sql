...
CREATE TABLE `presiones`  (
  ...
  `sistolica` int(11) NULL DEFAULT NULL,
  `diastolica` int(11) NULL DEFAULT NULL,
  ...
  CONSTRAINT `presiones_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = COMPACT;

-- ----------------------------
-- Records of presiones
-- ----------------------------
...
-- Records of sessions
-- ----------------------------
INSERT INTO `sessions` VALUES (1, '38f45a09bdee6ef00a5fd5efc6854471', 1, '2022-02-20 21:28:56', '2022-02-20 21:28:56');
