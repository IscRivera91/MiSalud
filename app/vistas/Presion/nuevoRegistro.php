...
$requiredClases = "required class='form-control'";
$fecha = date('Y-m-d');
$hora = date("H:i:s");
?>
<br>
<form autocomplete="off" role="form" method="POST"
      action="<?php echo Redireccion::obtener('Presion','registrarBd',SESSION_ID) ?>">
    <div class="row">
        <div class=col-md-3>
        ...
        <div class=col-md-3>
            <div class='input-group mb-3'>
                <input title='Hora' value="<?= $hora; ?>" name='hora' placeholder='Hora' <?= $requiredClases; ?> type='time'>
            </div>
        </div>
        <div class='col-md-12'></div>
        <div class=col-md-3>
